      ...
      <SheetContent side="bottom" className="h-[85vh] rounded-t-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-2">
            ...
            <Input id="title" value={form.title} onChange={(e) => setForm((p) => ({ ...p, title: e.target.value }))} placeholder="What's your question?" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="content">Details *</Label>
            <Textarea id="content" value={form.content} onChange={(e) => setForm((p) => ({ ...p, content: e.target.value }))} placeholder="Provide more context..." rows={4} />
          </div>
          <div className="space-y-2">
            <Label>Subject *</Label>
          ...
          <div className="space-y-2">
            ...
            <Input id="tags" value={form.tags} onChange={(e) => setForm((p) => ({ ...p, tags: e.target.value }))} placeholder="react, hooks, javascript" />
          </div>
          <SheetFooter>
