  ...
  public: {
    Tables: {
      ...
      chat_read_receipts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "chat_read_receipts_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      marketplace_favorites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "marketplace_favorites_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      poll_votes: {
        ...
        Relationships: [
          {
            foreignKeyName: "poll_votes_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "marketplace_listings"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      mark_room_messages_as_read: {
        Args: { p_chat_room_id: string; p_profile_id: string }
        Returns: number
      }
    }
    Enums: {
