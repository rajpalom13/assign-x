...
/**
 * Stat tile for project overview metrics with animations.
 */
function StatCard({
  title,
  value,
  ...
  return (
    ...
    >
      <Card className="border border-white/70 bg-white/85 shadow-[0_16px_35px_rgba(30,58,138,0.08)] transition-shadow duration-300 hover:shadow-[0_24px_48px_rgba(30,58,138,0.12)]">
        <CardContent className="flex items-center gap-4 p-5">
          <motion.div
            className={cn('flex h-12 w-12 items-center justify-center rounded-2xl', tone)}
...
export default function ProjectsPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]" variants={fadeInUp}>
        <motion.div className="space-y-5" variants={fadeInUp}>
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            >
              <Button
                ...
                className="gap-2 border-white/70 bg-white/80 shadow-[0_10px_22px_rgba(30,58,138,0.08)] transition-shadow hover:shadow-[0_14px_28px_rgba(30,58,138,0.12)]"
              >
                <motion.div
          ...
          >
            ...
            >
              ...
              <Input
                ...
                className="h-11 rounded-full border border-white/80 bg-white/85 pl-10 shadow-[0_10px_20px_rgba(148,163,184,0.12)] transition-all focus:shadow-[0_14px_28px_rgba(148,163,184,0.16)]"
              />
            </motion.div>
          ...
          >
            <motion.div
              className="rounded-3xl border border-white/70 bg-white/85 p-4 shadow-[0_16px_35px_rgba(30,58,138,0.08)] transition-all"
              variants={fadeInUp}
        ...
        <motion.div variants={fadeInUp}>
          <Card className="relative overflow-hidden border border-white/70 bg-gradient-to-br from-[#EEF2FF] via-[#F3F5FF] to-[#E9FAFA] shadow-[0_24px_60px_rgba(30,58,138,0.12)] transition-all hover:shadow-[0_28px_70px_rgba(30,58,138,0.16)]">
          ...
          <CardContent className="relative space-y-5 p-6">
            ...
            >
              <motion.div
                className="rounded-2xl bg-white/80 p-3 shadow-[0_10px_24px_rgba(148,163,184,0.12)] transition-all"
                variants={fadeInUp}
                whileHover={{ scale: 1.05, boxShadow: '0 14px 28px rgba(148,163,184,0.16)' }}
              >
            ...
            <AnimatePresence mode="wait">
              {priorityProject && (
                <motion.div
                  className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white/80 bg-white/80 p-3 shadow-[0_10px_24px_rgba(148,163,184,0.12)] transition-all"
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  whileHover={{ scale: 1.02, boxShadow: '0 14px 28px rgba(148,163,184,0.16)' }}
                >
                  <div>
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button
                      size="sm"
                      className="rounded-full bg-gradient-to-r from-[#5A7CFF] via-[#5B86FF] to-[#49C5FF] text-white shadow-[0_14px_28px_rgba(91,124,255,0.25)] transition-shadow hover:shadow-[0_18px_35px_rgba(91,124,255,0.35)]"
      ...
      >
        <div className="space-y-6">
          <motion.div
            className="rounded-[28px] border border-white/70 bg-white/85 p-5 shadow-[0_18px_40px_rgba(30,58,138,0.08)] transition-all"
            whileHover={{ y: -2, boxShadow: '0 20px 45px rgba(30,58,138,0.12)' }}
          >
            <ActiveProjectsTab
        ...
        <div className="space-y-6">
          ...
          <motion.div whileHover={{ y: -2 }}>
            <Card className="border border-white/70 bg-white/85 shadow-[0_16px_35px_rgba(30,58,138,0.08)] transition-shadow hover:shadow-[0_20px_45px_rgba(30,58,138,0.12)]">
